...
public class OSSClientUtil {
    ...
    public String uploadImg2Oss(String url) throws Exception {
        ...
        try {
            ...
            String substring = split[split.length-1].substring(split[split.length-1].lastIndexOf(".")).toLowerCase();
    ...
    public String uploadFile2OSS(InputStream instream, String fileName) {
        ...
        try {
            ...
            objectMetadata.setContentType(getcontentType("jpg"));
    ...
    public String uploadBufferImage(BufferedImage image) {
        InputStream inputStream = ImageUtil.imgToInputStream(image);
        String name = uploadFile2OSS(inputStream, UUID.randomUUID().toString()+".jpg");
        return name;
    }
